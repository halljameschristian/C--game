...
void home() {
	...
	if (!pixieCoreAssembled)
	{
		...
		case 2:
			...
			switch (tempchoice1) {
			case 1:
				cout << "You see the PIXIE CORE begin to vibrate, glow, and then shatter.  \n"
					<< "You're left with a sense of wonder, and your weapon seems more powerful!\n";
				playerAtk += 10;
				pixieCoreAssembled = false;
				pixieCoreFragments = 0;
				pixieCoreFragmentTotal = 100;
				break;
			case 2:
				cout << "You see the PIXIE CORE begin to vibrate, glow, and then shatter.  \n"
					<< "You're left with a sense of wonder, and your armor seems more powerful!\n";
				playerDef += 10;
				pixieCoreAssembled = false;
				pixieCoreFragments = 0;
				pixieCoreFragmentTotal = 100;
				break;
			case 3:
				cout << "You leave the crafting station, you feel the urges to use the power \n" 
					<< "of the PIXIE CORE begin to diminsh some.\n";
				break;
			}
		case 3:
			cout << "You left the house, now you are in the wild.\n";
